...
class MRCNERDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        Returns:
            ...
            [start/end]_label_mask: label mask, 1 for counting into loss, 0 for ignoring. [seq_len]
...
def run_dataset():
    ...
    json_path = "/home/b317l704/sentence_classifer_git/datasets/DS0/mrc-ner.train"
    ...
    for batch in dataloader:
        ...
        print(tokens.shape, start_labels.shape, match_labels.shape)
